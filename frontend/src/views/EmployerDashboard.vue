  ...
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div class="md:col-span-1 flex flex-col justify-center">
        <h2 class="text-2xl font-bold text-slate-900 tracking-tight">Leave Requests</h2>
      ...
      <div class="md:col-span-2 grid grid-cols-2 gap-4">
        ...
        <!-- Pending Card -->
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-5 flex items-center gap-4 hover:shadow-md transition-shadow">
          <div class="h-12 w-12 rounded-full bg-amber-50 flex items-center justify-center text-amber-600 flex-shrink-0">
            <Clock class="w-6 h-6" />
          </div>
          <div>
        ...
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden flex flex-col ring-1 ring-slate-900/5">
          ...
          <div class="p-6">
            ...
            <div class="mb-6">
              ...
              <textarea v-model="reviewComment" rows="3" placeholder="Add your notes or reasoning here for the employee to see..." class="block w-full rounded-xl border-slate-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-4 py-3 bg-slate-50 border resize-none outline-none"></textarea>
            </div>
